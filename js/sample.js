...
// Two additional demo deals so a returning visitor can line up a three-way
// comparison without hand-entering properties. Deliberately spread across the
// quality range: 715 Plumas is the weak value-add (CAP 5.13%, DSCR 0.84),
// Orange Grove is a strong stabilized retail strip (CAP ~7.4%, DSCR ~1.23), and
// 1120 K Street sits in between (CAP ~6.9%, DSCR ~1.13). Fixed ids keep the
// "Add sample properties" action idempotent (re-adding overwrites in place,
// never duplicates). Same assumptions as 715 so the comparison is apples-to-
// apples on the model side. Invented addresses/rent rolls — illustrative only.
export function comparisonSamples() {
  ...
  return [
    {
      id: 'sample-4324-orange-grove',
      schemaVersion: 1,
      name: '4324 Orange Grove Ave — Retail',
      createdAt: '2026-07-16T00:00:00.000Z',
      updatedAt: '2026-07-16T00:00:00.000Z',
      info: {
        askingPrice: 1650000, rentableSF: 12000, lotSize: '24,400 sf', yearBuilt: 1986,
        zoning: 'C2', hvacAge: '3 yr', roofAge: '5 yr', parking: '32 spaces',
        ceilingHeight: '14 ft', appraisedValue: 0, apn: '—',
        bedrooms: '—', baths: '—',
      },
      targets: { desiredCap: 0, desiredDscr: 0 },
      offer: { offerPrice: 1600000, fees: 0, improvements: 0 },
      loans: [
        { ltv: 0.70, rate: 0.065, termYears: 25, maturityYears: 10, type: 'CONV' },
      ],
      tenants: [
        { name: 'Grocery outlet', sf: 8200, monthlyIncome: 6800, leaseExpires: '2031-06-30', leaseOptions: '2×5 yr' },
        { name: 'Nail salon', sf: 1350, monthlyIncome: 2300, leaseExpires: '2029-02-28', leaseOptions: '—' },
        { name: 'Cell phone store', sf: 1300, monthlyIncome: 1900, leaseExpires: '2028-09-30', leaseOptions: '—' },
        { name: 'Insurance office', sf: 1150, monthlyIncome: 1000, leaseExpires: '2030-12-31', leaseOptions: '—' },
      ],
      expenses: [
        { key: 'insurance', label: 'Insurance', amount: 8000, included: true, estimated: false },
        { key: 'taxes', label: 'Property taxes', amount: 17600, included: true, estimated: true },
        { key: 'hoa', label: 'HOA', amount: 0, included: true, estimated: false },
        { key: 'utilities', label: 'Utilities', amount: 0, included: true, estimated: false },
        { key: 'management', label: 'Management', amount: 5760, included: false, estimated: true },
        { key: 'maintenance', label: 'Maintenance', amount: 0, included: true, estimated: false },
        { key: 'landscaping', label: 'Landscaping', amount: 0, included: true, estimated: false },
        { key: 'cleaning', label: 'Cleaning', amount: 0, included: true, estimated: false },
    ...
    {
      id: 'sample-1120-k-street',
      schemaVersion: 1,
      name: '1120 K Street — Mixed-use',
      createdAt: '2026-07-16T00:00:00.000Z',
      updatedAt: '2026-07-16T00:00:00.000Z',
      info: {
        askingPrice: 985000, rentableSF: 4300, lotSize: '6,100 sf', yearBuilt: 1924,
        zoning: 'CBD', hvacAge: '8 yr', roofAge: '12 yr', parking: '6 spaces',
        ceilingHeight: '11 ft', appraisedValue: 0, apn: '—',
        bedrooms: '—', baths: '—',
      },
      targets: { desiredCap: 0, desiredDscr: 0 },
      offer: { offerPrice: 950000, fees: 0, improvements: 0 },
      loans: [
        { ltv: 0.72, rate: 0.062, termYears: 25, maturityYears: 10, type: 'CONV' },
      ],
      tenants: [
        { name: 'Corner cafe', sf: 1800, monthlyIncome: 2600, leaseExpires: '2029-08-31', leaseOptions: '1×5 yr' },
        { name: 'Apartment 2A', sf: 900, monthlyIncome: 1700, leaseExpires: '2027-05-31', leaseOptions: '—' },
        { name: 'Apartment 2B', sf: 900, monthlyIncome: 1700, leaseExpires: '2027-07-31', leaseOptions: '—' },
        { name: 'Barber shop', sf: 700, monthlyIncome: 800, leaseExpires: '2028-03-31', leaseOptions: '—' },
      ],
      expenses: [
        { key: 'insurance', label: 'Insurance', amount: 6000, included: true, estimated: false },
        { key: 'taxes', label: 'Property taxes', amount: 10450, included: true, estimated: true },
        { key: 'hoa', label: 'HOA', amount: 0, included: true, estimated: false },
        { key: 'utilities', label: 'Utilities', amount: 3600, included: true, estimated: true },
        { key: 'management', label: 'Management', amount: 4080, included: false, estimated: true },
        { key: 'maintenance', label: 'Maintenance', amount: 0, included: true, estimated: false },
        { key: 'landscaping', label: 'Landscaping', amount: 0, included: true, estimated: false },
        { key: 'cleaning', label: 'Cleaning', amount: 0, included: true, estimated: false },
        { key: 'misc', label: 'Misc', amount: 0, included: true, estimated: false },
