...
function blankProperty() {
  return {
    ...
    info: { propertyType: 'Commercial', askingPrice: 0, rentableSF: 0, lotSize: '', yearBuilt: '', zoning: '', hvacAge: '', roofAge: '', parking: '', ceilingHeight: '', appraisedValue: 0, apn: '', bedrooms: '', baths: '', subtype: '', broker: '', photosLink: '', description: '' },
